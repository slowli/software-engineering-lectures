...
\begin{document}
	...
	% TODO figure: logic program execution
	...
	\frame{
		...
		\begin{itemize}
			...
			\vspace{0.5ex}
			\textbf{Языки программирования:} C++, Java, C\#, Python.
			...
			\vspace{0.5ex}
			\textbf{Языки программирования:} JavaScript, Lua.
		\end{itemize}
	}
	...
	\frame{
		...
		\lstinputlisting[language=python]{code-fib.py}

...
\begin{document}
	...
	\frame{
		...
		\begin{itemize}
			\item
			\textbf{среды разработки} — встроенные средства или плагины для проведения инспекций / неформальных обзоров кода;

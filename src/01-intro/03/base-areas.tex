...
\begin{document}
	...
	\frame{
		...
		\vspace{1ex}
		\begin{overlayarea}{\textwidth}{0.77\textheight}
			\only<1>{
				...
				\begin{columns}
					\begin{column}{0.47\textwidth}
						\begin{figure}
							\includegraphics[width=\textwidth]{decorator.png}\vspace{-3ex}
			...
			\only<2>{
				...
				\begin{columns}
					\begin{column}{0.35\textwidth}
						\begin{figure}
							\includegraphics[width=0.8\textwidth]{state-diagram.png}\vspace{-2.5ex}

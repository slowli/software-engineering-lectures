...
\title[Метапрограммирование]{Тестирование программного обеспечения}
...
\begin{document}
	...
	\frame{
		...
		\begin{center}
			...
			\vspace{1ex}
			\figureexpl{В каскадной модели тестирование — отдельный этап разработки, следующий за написанием кода.}
		\end{center}
	}
	...
	\frame{
		...
		\begin{center}
			...
			\vspace{1ex}
			\figureexpl{Согласно эволюционной модели разработки ПО, тестирование неразрывно связано с конструированием.}
		\end{center}
	}
	...
	\frame{
		...
		\begin{enumerate}
			\item
			Разработка тестовых примеров \engterm{test cases}.
			...
			\vspace{0.5ex}
			\item
			Выполнение программы на тестовых данных.
	...
	\frame{
		...
		\begin{itemize}
			\item
			Анализ граничных значений \engterm{boundary-value analysis}.
			...
			\begin{center}
				...
				\vspace{1ex}
				\figureexpl{Граничные значнения для целочисленной величины, обозначающей процент.}
			\end{center}

			\vspace{1ex}
			\item
			Комбинаторные методы: \extlink{http://en.wikipedia.org/wiki/All-pairs_testing}{уникальные пары значений}, 
			\extlink{http://en.wikipedia.org/wiki/Orthogonal_array_testing}{ортогональные массивы}.
	...
	\frame{
		...
		\lstinputlisting{code-junit.java}
	}
	...
	\frame{
		...
		\begin{itemize}
			...
			\item
			корректность работы с нулевыми указателями (\textbf{null}) при передаче объектов;
			\item
	...
	\frame{
		...
		\begin{itemize}
			\item
			Скрупулезное тестирование всего выполняемого кода; 
	...
	\frame{
		...
		\begin{itemize}
			\item
			Тестирование отдельных пользовательских требований 
			(1 требование = много тестов).

			\vspace{1ex}
			\item
			Тестирование сценариев использования ПО 
	...
	\frame{
		...
		\begin{center}
			\ifbigpages\input{fig-load-a4.tex}\else\input{fig-load.tex}\fi
		\end{center}

		\figureexpl{%
			Различные режимы тестирования производительности: \vspace{-1ex}
			\begin{multicols}{2}
				\quad\textbf{\color{gray}1} — нагрузочное тестирование \engterm{load testing}; \\
				\quad\textbf{\color{green}2} — стресс-тестирование \engterm{stress testing}; \\
				\quad\textbf{\color{blue}3} — тестирование выносливости \engterm{soak testing}; \\
				\quad\textbf{\color{red}4} — импульсное тестирование \engterm{spike testing}.
			\end{multicols}
		}
	}

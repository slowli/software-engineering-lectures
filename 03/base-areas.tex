...
\begin{document}
	...
	\frame{
		...
		\vspace{1ex}
		\textbf{Цель требований:} определение функций, условий и ограничений, присущих ПО; спецификация данных, 
		технического сопровождения и среды исполнения.
	}
	...
	\frame{	
		...
		\vspace{1ex}
		\textbf{Нефункциональные требования} — определяют условия исполнения~ПО, переносимости и~доступа к~данным.
	...
	\frame{
		...
		\begin{center}
			{\small\input{fig-req-classic.tex}}
	...
	\frame{
		...
		\begin{overlayarea}{\textwidth}{0.6\textheight}
			{\small\input{fig-req-process.tex}}
		\end{overlayarea}
	}
	...
	\frame{
		...
		\vspace{1ex}
		\textbf{Техники конструирования:} кодирование, верификация, модульное тестирование (unit testing), 
		тестирование итеграции (integration testing), отладка (debugging).

		\vspace{1ex}
		\textbf{Инструменты конструирования:} языки конструирования; программные методы и~инструментальные системы 
		(компиляторы, СУБД, генераторы отчетов, системы управления версиями, конфигурацией, тестированием).
	}
